...
# Fang: an example of the nested function
def plot_tsne(X, imgs, outFile):
# function apply tsne on x, and plot t-sne embeddings
# x is the trained embeddings after flatten
# imgs is the real image, 100*100*3 RGB
    ...
    X_tsne = tsne.fit_transform(X) # fit flattened embedding to space and return the transformed output
    print(X_tsne.shape, X.shape)
